...
class CreateDashboardHomesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dashboard_homes', function (Blueprint $table) {
            ...
            $table->integer('mid_content_img_1')->nullable();
            $table->text('mid_content_img_id_1')->nullable();
            $table->text('mid_content_text_1')->nullable();
            $table->text('mid_content_desc_1')->nullable();
            $table->integer('mid_content_img_2')->nullable();
            $table->text('mid_content_img_id_2')->nullable();
            $table->text('mid_content_text_2')->nullable();
            $table->text('mid_content_desc_2')->nullable();
            $table->integer('mid_content_img_3')->nullable();
            $table->text('mid_content_img_id_3')->nullable();
            ...
            $table->integer('mid_content_bg')->nullable();
